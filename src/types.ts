...
export interface TimedProductionItem {
  id: string;
  data: string;
  articolo: string;
  quantita: number;
...
export interface Macchina5000 extends TimedProductionItem {}
export interface TaglioLaser extends TimedProductionItem {}
export interface FaseTimed extends TimedProductionItem {
  lavorazione_per?: string;
  fatto?: number;
  stampato?: number;
}
