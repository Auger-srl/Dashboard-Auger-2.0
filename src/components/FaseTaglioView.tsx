            ...
            <table className="w-full text-left border-collapse">
              <thead className="bg-slate-50 text-slate-500 text-xs uppercase font-semibold">
                <tr>
                  ...
                  <th className="px-6 py-4 border-b border-slate-200">Note</th>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100">
                {archiveRows.length === 0 ? (
                  <tr>
                    <td colSpan={viewMode === 'archivio-stampe' ? 10 : 9} className="px-6 py-8 text-center text-slate-500">
                  ...
                  archiveRows.map((row) => (
                    <tr key={row.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-slate-600">{row.articolo}</td>
                      <td className="px-6 py-4 text-[10px] text-orange-600 font-bold">{row.note || ''}</td>
                      <td className="px-6 py-4 text-center font-bold text-slate-800">{row.quantita}</td>
                      <td className="px-6 py-4 text-center text-slate-600">
                        {row.data && !isNaN(new Date(row.data).getTime()) ? new Date(row.data).toLocaleDateString('it-IT') : '-'}
                      </td>
